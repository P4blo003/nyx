...
from eval.forecasting import eval_forecasting
...
if __name__ == "__main__":
    ...
    try:
        ...
        data, train_slice, valid_slice, test_slice, scaler, pred_lens, n_covariate_cols = dataset.SIECDatasetLoader().load()
        ...
        out, eval_res = eval_forecasting(
            ...
            n_covariates_cols=n_covariate_cols
        )
