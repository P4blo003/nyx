...
Chrono depende de PyTorch y otras librerías de Python para procesamiento de datos, entrenamiento y visualización. Se recomienda instalar todo de forma estructurada.

#### 4.1 PyTorch.

Chrono se basa en PyTorch para operaciones tensoriales y soporte GPU. Es importante instalar la versión de PyTorch compatible con tu versión CUDA.
